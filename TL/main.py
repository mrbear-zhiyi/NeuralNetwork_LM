...
from utils.NeuralNetwork_LM_debug import  NeuralNetwork_LM_train_debug
from utils.NeuralNetwork_LM import  NeuralNetwork_LM_train
import pandas as pd
...
def main(path_json):
    ...
    print('\n======================================== NeuralNetwork =========================================\n')
    # NeuralNetwork_LM_train_debug('./results/01_preprocess/nuclide_data_modified.csv')
    NeuralNetwork_LM_train('./results/01_preprocess/nuclide_data_modified.csv')
